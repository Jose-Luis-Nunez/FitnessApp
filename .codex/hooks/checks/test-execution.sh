...
run_grind_loop \
  ...
  "Test files changed but no test run detected. Run the affected package tests using xcodebuild (see build-and-test rule). Write results to .claude/hooks/state/test-execution.stamp.md. Changed test files: ${test_file_list}."
