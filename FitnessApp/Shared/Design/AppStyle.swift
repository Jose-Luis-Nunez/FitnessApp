...
enum AppStyle {
    ...
    enum Font {
        ...
        static let cardHeadline = SwiftUI.Font.system(size: 20, weight: .bold)
        ...
        static let extraLargeChip = SwiftUI.Font.system(size: 24, weight: .semibold)
    ...
    enum Color {
        ...
        static let exerciseCardBackgroundInactive = exerciseCardBackground
