...
public struct MuscleCategoryView: View {
    ...
    public var body: some View {
        ...
        .alert(AppText.exerciseResetPromptTitle, isPresented: $viewModel.showResetConfirmation) {
            Button(AppText.actionReset, role: .destructive) {
                viewModel.resetProgress()
            }
            Button(AppText.actionCancel, role: .cancel) { }
        } message: {
            Text(AppText.exerciseResetPrompt)
        }
    }
                        ...
                        MiniActionMenuView(
                            ...
                            items: {
                                ...
                                if viewModel.showNewExercise {
                                    items.append(MiniActionMenuItem(id: "new-exercise", icon: "plus", title: AppText.exerciseNew, isDestructive: false) {
                                        withAnimation {
                                ...
                                if viewModel.showStartTraining {
                                    items.append(MiniActionMenuItem(id: "start-training", icon: "play.fill", title: AppText.trainingStart, isDestructive: false) {
                                ...
                                if viewModel.showCancel {
                                    items.append(MiniActionMenuItem(id: "cancel-training", icon: "xmark", title: AppText.actionCancel, isDestructive: false) { [overlayState] in
                                ...
                                if viewModel.showReset {
                                    items.append(MiniActionMenuItem(id: "reset-exercises", icon: "arrow.counterclockwise", title: AppText.actionReset, isDestructive: false) {
