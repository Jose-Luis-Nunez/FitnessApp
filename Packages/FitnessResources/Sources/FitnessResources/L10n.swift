public enum L10n {
    ...
    public static let cardCreationPlaceholderTextRepetitions = "Repetitions"
    public static let cardCreationPlaceholderTextSets = "Sets"
    ...
    public static let muscleCategoryMuscleGroupsTitle = "Muscle Groups"
    public static let muscleCategoryOptionArms = "Arm"
    public static let muscleCategoryOptionChest = "Chest"
    public static let muscleCategoryOptionBack = "Back"
    public static let muscleCategoryOptionLegs = "Legs"
    public static let muscleCategoryOptionAbs = "Abs"

    public static let sheetTitleWeight = "Edit Weight"
    public static let sheetTitleSets = "Edit Sets"
    public static let sheetTitleReps = "Edit Repetitions"
    public static let sheetTitleSeat = "Edit Seat Setting"

    public static let sheetPlaceholderWeight = "New Weight"
    public static let sheetPlaceholderSets = "New Count"
    public static let sheetPlaceholderReps = "New Count"
    public static let sheetPlaceholderSeat = "New Setting"

    public static let workoutFallbackName = "Your Workout"
}
