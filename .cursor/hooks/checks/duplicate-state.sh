...
$CACHE_HITS
Two lifecycles for one identity = sync bug (see Bug 1). Prefer @Bindable on @Model, @Environment-injected single source, or pure-rendering view. See .cursor/skills/reviewing-code-changes/SKILL.md §13h.
EOF
