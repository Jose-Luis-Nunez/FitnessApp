...
| [0002](../../docs/adr/0002-persistence-ui-package.md) | FitnessPersistenceUI Package | accepted (T4 skeleton + T5 cards + T6 tile + T7-0 cycle-break + T7a tile rollout landed) |
...
Tests/
  ...
  Packages/*/Tests/       — Package-level unit tests per SPM module
    ...
    FitnessExerciseTests/   — MuscleCategorySelectionViewModelTests (categories, exercise counts, card VM cache, reset, find category, exercise mutations, coordinator completion integration, exercise stability, **T7a `currentWorkoutId` exposure**), ExerciseFormViewModelTests, ResetAllExercisesUseCaseTests
