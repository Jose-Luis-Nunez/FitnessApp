...
| `CardTheme` | `Packages/FitnessUI/Sources/FitnessUI/CardTheme.swift` | Bundles `CardSurfaceStyle` + title/subtitle colors + title font. Static presets: `.idle` (gradient surface, mint text), `.completed` (glass surface, white text). |
